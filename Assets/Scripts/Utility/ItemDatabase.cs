...
public class ItemDatabase {
    ...
    private List<Item> items = new List<Item>(){
        new Equip("Sword", "sword-0", "This is a sword.", null, ItemType.equip, EquipType.primary, new EquipStats(1f), "Models/Equipment/Weapons/Melee/Swords/sword", "Animators/swordAndShield"),
